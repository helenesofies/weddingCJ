...
import vacation from '../components/Images/vacation.png'
    ...
    <PasswordProtection>
      <div className={styles.container}>
        ...
        <div className={styles.general}>
          ...
          />
          <div className={styles.generalText}><p>We can't wait to party with you at 19:00!</p></div>
          <button className={styles.rsvpButton} ><a href='/rsvp'>RSVP</a></button>
        </div>
          ...
          <div className={styles.faq}>
            <div className={styles.faqItem} onClick={() => setAccomodationOpen(!isAccomodationOpen)}>
              <div className={styles.faqHeader}>
                <HotelSVG />
                <div className={styles.faqHeaderText}>
                  <p className={styles.faqTitle}>Food and drinks</p>
                  <p className={styles.faqSubtitle}>Don’t worry we will feed you!</p>
                </div>
              </div>
              <Plus />
            </div>
            ...
            {isAccomodationOpen && (
              <div className={styles.faqAnswer}>
                <p>
                  There will be a light buffet with snacks, cakes and coffee. If you have any dietary requirements please let us know before 31st of August. Throughout the evening we will provide an open bar supplied with beer, wine and soft drinks for you to enjoy:)
